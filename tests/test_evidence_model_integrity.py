...
from app.db.models import ExtractedSignal, NicheHypothesis, NicheScore, ResearchRun, SignalCluster, SourceItem, SourceItemQueryLink, SourceQuery
...
def test_evidence_tables_exist_in_base_metadata() -> None:
    assert {"source_items", "source_queries", "source_item_query_links", "extracted_signals", "signal_clusters", "niche_hypotheses", "niche_scores"}.issubset(
